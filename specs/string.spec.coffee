...
describe 'String helper', ->
    ...
    it 'left pads strings', ->
        F.leftPad(3, 2).should.eql('03')
        F.leftPad(3, 6).should.eql('000003')
        F.leftPad(189, 6).should.eql('000189')

        F.leftPad(342, 5, ' ').should.eql('  342')
        F.leftPad('Banzai', 10, '_').should.eql('____Banzai')

        F.leftPad(189, 1).should.eql('189')
        F.leftPad(189, 2).should.eql('189')
        F.leftPad(189, 3).should.eql('189')
        F.leftPad(189, 4).should.eql('0189')
